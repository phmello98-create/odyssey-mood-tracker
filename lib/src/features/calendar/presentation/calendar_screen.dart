...
class _CalendarScreenState extends ConsumerState<CalendarScreen> {
  ...
  void _initShowcase() {
    ...
    showcase.ShowcaseService.startIfNeeded(
      showcase.ShowcaseTour.calendar,
      keys,
    );
  }
                    ...
                    return ValueListenableBuilder(
                      ...
                      builder: (context, timeBox, _) {
                        ...
                        final selectedTimes = timeRecords
                            ...
                            .toList();
                        final selectedTasks = _getTasksForDay(
                          _selectedDay,
                          allTasks,
                        );
                        final relativeLabel = _getRelativeDateLabel(
                          context,
                          _selectedDay,
                        );
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: TableCalendar<dynamic>(
                                ...
                                eventLoader: (day) {
                                  final moods = moodRecords
                                      .where((r) => _isSameDay(r.date, day))
                                      .length;
                                  final times = timeRecords
                                      .where(
                                        (r) => _isSameDay(r.startTime, day),
                                      )
                                      .length;
