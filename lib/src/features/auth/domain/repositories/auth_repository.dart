...
abstract class AuthRepository {
  ...
  /// Converter conta de visitante em conta real com Email/Senha
  ///
  /// Permite que um usuário guest crie uma conta mantendo seus dados.
  /// Usa linkWithCredential se for Firebase Anonymous.
  Future<AuthResult> upgradeGuestAccount(String email, String password);

  /// Converter conta de visitante em conta real com Google
  ///
  /// Permite que um usuário guest vincule conta Google mantendo seus dados.
  /// Usa linkWithCredential se for Firebase Anonymous.
