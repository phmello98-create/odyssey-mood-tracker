...
String getLocalizedCategoryName(BuildContext context, String categoryName) {
  ...
  switch (categoryName) {
    case "Social":
      return loc.activityCategorySocial;
    case "Hobbies":
      return loc.activityCategoryHobbies;
    case "Sleep":
      return loc.activityCategorySleep;
    case "Health":
      return loc.activityCategoryHealth;
    case "Better Me":
      return loc.activityCategoryBetterMe;
    case "Chores":
      return loc.activityCategoryChores;
    default:
      return categoryName;
  }
}
...
String getLocalizedActivityName(BuildContext context, String activityName) {
  final loc = AppLocalizations.of(context)!;
  switch (activityName) {
    case "family":
      return loc.activityFamily;
    case "friends":
      return loc.activityFriends;
    case "date":
      return loc.activityDate;
    case "party":
      return loc.activityParty;
    case "movies & tv":
      return loc.activityMoviesTv;
    case "reading":
      return loc.activityReading;
    case "gaming":
      return loc.activityGaming;
    case "relax":
      return loc.activityRelax;
    case "sleep early":
      return loc.activitySleepEarly;
    case "good sleep":
      return loc.activityGoodSleep;
    case "medium sleep":
      return loc.activityMediumSleep;
    case "bad sleep":
      return loc.activityBadSleep;
    case "excercise":
      return loc.activityExercise;
    case "drink water":
      return loc.activityDrinkWater;
    case "walk":
      return loc.activityWalk;
    case "meditation":
      return loc.activityMeditation;
    case "kindness":
      return loc.activityKindness;
    case "listen":
      return loc.activityListen;
    case "donate":
      return loc.activityDonate;
    case "give gift":
      return loc.activityGiveGift;
    case "shopping":
      return loc.activityShopping;
    case "cleaning":
      return loc.activityCleaning;
    case "cooking":
      return loc.activityCooking;
    case "laundry":
      return loc.activityLaundry;
    default:
      return activityName;
  }
}
