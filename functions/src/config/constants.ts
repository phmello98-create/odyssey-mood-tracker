...
export const PEAK_HOURS = [8, 9, 10, 12, 13, 14, 19, 20, 21, 22];
...
export const CRISIS_RESPONSE = `💙 Você não está sozinho.
...
export const BOT_COLORS = {
    [BOT_IDS.BEATNIX]: '#6366F1', // Indigo
    [BOT_IDS.ERRO404]: '#10B981', // Emerald
    [BOT_IDS.WIKI]: '#8B5CF6',    // Violet
    [BOT_IDS.TURBO]: '#F59E0B',   // Amber
};

// Flairs dos bots
export const BOT_FLAIRS = {
    [BOT_IDS.BEATNIX]: '🎧 Robô Residente',
    [BOT_IDS.ERRO404]: '🤖 Estagiário de Silício',
    [BOT_IDS.WIKI]: '🧠 Banco de Dados Vivo',
    [BOT_IDS.TURBO]: '⚡ Gerente de Caos',
};
