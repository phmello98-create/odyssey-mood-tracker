...
exports.BOT_PERSONALITIES = void 0;
exports.getBotPersonality = getBotPersonality;
exports.getRandomExamplePost = getRandomExamplePost;
const constants_1 = require("../config/constants");
exports.BOT_PERSONALITIES = {
...
function getBotPersonality(botId) {
    return exports.BOT_PERSONALITIES[botId] || null;
}
/**
 * Retorna um exemplo de post aleatório de um bot
 */
function getRandomExamplePost(botId) {
    const personality = exports.BOT_PERSONALITIES[botId];
    if (!personality)
        return '';
    const examples = personality.examplePosts;
    return examples[Math.floor(Math.random() * examples.length)];
}
//# sourceMappingURL=botPersonalities.js.map